    ...
    const mycart = this.context.mycart.map((item, index) => {
      return (
        <tr key={item.product._id}>
          ...
          <td>
            <span
              className="table-action-link remove-link"
            ...
            <table className="modern-table">
              ...
              <tbody>
                ...
                <tr className="total-row">
                  <td colSpan="6"></td>
                  <td className="mycart-total-label">TỔNG TIỀN</td>
                  <td className="mycart-total-value">
                    {CartUtil.getTotal(this.context.mycart).toLocaleString('vi-VN')} ₫
                  </td>
                  <td>
                    <span
                      className="table-action-link checkout-link"
