...
class Signup extends Component {
      ...
      <div className="customer-content">
        <div className="form-container">
          <div className="modern-form-card">
            ...
            <p className="form-subtitle">Tạo tài khoản để nhận nhiều ưu đãi nội thất</p>
  ...
  btnSignupClick(e) {
    ...
    if (!username || !password || !name || !phone || !email) {
      alert('Vui lòng nhập đầy đủ tên đăng nhập, mật khẩu, họ tên, số điện thoại và email');
      return;
    }
